...
extension ScreenshotExtension on IntegrationTestWidgetsFlutterBinding {
  ...
  Future<void> takeScreenshot(String name) async {
    ...
    // Take the screenshot
    final bytes = await takeScreenshot(name);
    
    // Note: On iOS/Android simulators, screenshots are saved by the test framework
    // For local development, you may need to handle saving manually
